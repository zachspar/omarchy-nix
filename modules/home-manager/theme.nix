    ...
    lib.mkMerge [
      {
        ...
        # Existing GTK settings from a first login / Plasma session otherwise
        # abort Home Manager at checkLinkTargets, and Hyprland keeps the
        # autogenerated lua stub (no Super+Return, no Waybar).
